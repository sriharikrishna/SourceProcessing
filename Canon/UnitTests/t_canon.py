...
class TestFunctionToSubroutine(TestCase):    
    def test1(self):
        ...
        compareFiles(self.assertEquals,'funDef2subDef.f','funDef2subDef.pre.f',free=True)

    def test2(self):
        'test converting function to subroutine 2'
        compareFiles(self.assertEquals,'funDef2subDef2.f','funDef2subDef2.pre.f',free=True)
    ...
    def test3(self):
        ...
        compareFiles(self.assertEquals,'funDef2subDef3.f','funDef2subDef3.pre.f',free=True)
...
class TestCanonicalizeEllipsis(TestCase):
    def test1(self):
        ...
        compareFiles(self.assertEquals,'ellipsisFunCall.f90','ellipsisFunCall.pre.f90',free=True)
